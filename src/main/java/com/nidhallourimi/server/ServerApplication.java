    ...
    CommandLineRunner run(ServerRepo serverRepo){
        return args -> {
            serverRepo.save(new Server(null,"192.168.1.160","Ubuntu Linux","16 GB","personal pc",
                    "http://localhost:8080/server/image/server1.jpg", SERVER_UP));
            serverRepo.save(new Server(null,"192.168.1.55","Ubuntu Linux","16 GB","dell tower",
                    "http://localhost:8080/server/image/server3.png", SERVER_UP));
            serverRepo.save(new Server(null,"192.168.1.68","MS 2000","32 GB","web server",
